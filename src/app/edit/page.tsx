...
export default function EditPage({ searchParams }: { searchParams: { publicId: string } }) {
  ...
  const [pendingPrompt, setPendingPrompt] = useState(""); // Input    => (e.currentTarget.value)
  const [prompt, setPrompt] = useState("");               // CldImage => fillBackground={{ prompt, }}
    ...
    <section>
      <div className="flex flex-col gap-8">
        ...
        <div className="flex gap-4">
          ...
          {/* Generative fill transformation (1)  */}
